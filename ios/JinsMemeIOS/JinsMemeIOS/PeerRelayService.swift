...
final class PeerRelayService: NSObject, ObservableObject {
    ...
    func broadcast(frame: SensorFrame) {
...
extension PeerRelayService: MCSessionDelegate, MCNearbyServiceAdvertiserDelegate, MCNearbyServiceBrowserDelegate {
